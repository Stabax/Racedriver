...
bool preparatifsCourse(const Circuit& Map, const Profil& Player, Car*& CarPlayer, int const& prix = 0);
...
void faireCourseCarriere(Circuit Map, Car* Player1, Profil& Player);
