...
//Constructeurs
PriseAir::PriseAir(const std::string& modele, const char& rang, const unsigned short int& aerodynamisme):m_nom(modele), m_rang(rang), m_aerodynamisme(aerodynamisme)
{
}
...
//Methodes statiques
PriseAir* PriseAir::chargerPriseAir(const unsigned short int& id)
{
...
unsigned short int PriseAir::getAerodynamisme() const
{
